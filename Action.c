Action()
{
	...
	web_reg_save_param_ex("paramName=C_OrderId","LB=<a href=\"","RB=/edit\" class=\"btn btn-primary\">",LAST);
	...
	lr_think_time(19);
   	...
   	web_reg_save_param_ex("paramName=C_petList","LB=\">","RB=</option>","ordinal=1",LAST);

    	
	lr_start_transaction("Pets_AddNewPet");

	web_url("Add New Pet", 
		"URL=http://pets.shaft.com/owners/{C_OrderId}/pets/new", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=text/html", 
		"Referer=http://pets.shaft.com/owners/{C_OrderId}", 
		"Snapshot=t5.inf", 
		"Mode=HTML", 
		LAST);
	...
	web_submit_data("new", 
		"Action=http://pets.shaft.com/owners/{C_OrderId}/pets/new", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		"Referer=http://pets.shaft.com/owners/{C_OrderId}/pets/new", 
		"Snapshot=t6.inf", 
		"Mode=HTML", 
		ITEMDATA, 
		...
		"Name=type", "Value={C_petList}", ENDITEM, 
		LAST);
